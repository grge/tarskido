<template>
  ...
  >
    ...
    <g v-if="nodeType.primary === 'Definition'">
      ...
      <circle
        v-if="nodeType.secondary === 'Definition'"
        cx="8"
        cy="8"
        r="7"
        fill="none"
      ...
      <template v-else-if="nodeType.secondary === 'Axiom'">
        ...
        <path
          d="M8 3 L9.5 6.5 L13 6.5 L10.25 8.75 L11.5 12.5 L8 10 L4.5 12.5 L5.75 8.75 L3 6.5 L6.5 6.5 Z"
          fill="currentColor"
        />
      </template>
    ...
    <g v-else-if="nodeType.primary === 'Proposition'">
      ...
      <rect
        v-if="nodeType.secondary === 'Theorem'"
        x="1"
        y="1"
        width="14"
        height="14"
    ...
    <g v-else-if="nodeType.primary === 'Group'">
      ...
      <rect
        v-else-if="nodeType.secondary === 'Section'"
        x="2"
        y="7"
        width="12"
        height="2"
      ...
      <rect
        v-else-if="nodeType.secondary === 'Subsection'"
        x="2"
        y="7.5"
        width="12"
        height="1"
    ...
    <g v-else-if="nodeType.primary === 'Comment'">
      <!-- Example: filled star -->
      <path
        v-if="nodeType.secondary === 'Example'"
        d="M8 1 L10 6 L15 6 L11.5 9.5 L13 15 L8 12 L3 15 L4.5 9.5 L1 6 L6 6 Z"
        fill="currentColor"
      />

      <!-- Note: empty star -->
      <path
        v-else-if="nodeType.secondary === 'Note'"
        d="M8 1 L10 6 L15 6 L11.5 9.5 L13 15 L8 12 L3 15 L4.5 9.5 L1 6 L6 6 Z"
        fill="none"
        stroke="currentColor"
        stroke-width="1"
